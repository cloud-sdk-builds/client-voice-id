...
[`@aws-sdk/client-voice-id`](https://www.npmjs.com/package/@aws-sdk/client-voice-id/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uePIder+llB2wGs8mivdrOF75fxVmHG4IoYpjI0CEpdr/Rxm0rZj08IMSI864sFw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-voice-id": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.563.0/index.min.mjs": "sha384-uePIder+llB2wGs8mivdrOF75fxVmHG4IoYpjI0CEpdr/Rxm0rZj08IMSI864sFw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-voice-id/blob/refs/tags/3.563.0/LICENSE
```
