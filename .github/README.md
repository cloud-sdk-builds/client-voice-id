...
[`@aws-sdk/client-voice-id`](https://www.npmjs.com/package/@aws-sdk/client-voice-id/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kj2rylaCCPG82dGXkN5EOMzEA2RykXcopCIKw8ti7xI7S3u+u3zDcn122T3W5nVr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-voice-id": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.775.0/index.min.mjs": "sha384-Kj2rylaCCPG82dGXkN5EOMzEA2RykXcopCIKw8ti7xI7S3u+u3zDcn122T3W5nVr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-voice-id/blob/refs/tags/3.775.0/LICENSE
```
