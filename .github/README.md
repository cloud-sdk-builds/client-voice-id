...
[`@aws-sdk/client-voice-id`](https://www.npmjs.com/package/@aws-sdk/client-voice-id/v/3.1118.0).
...
- @aws-sdk/client-voice-id v3.1118.0 - [https://cloud-sdk-builds.github.io/?sdk=client-voice-id&version=3.1118.0](https://cloud-sdk-builds.github.io/?sdk=client-voice-id&version=3.1118.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.1118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpoz5rtI7qI1qfZHz7++BAELPvI/mqLP19jRWujoVzUc4vUBUt6L6QOql6ZBc+SC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-voice-id": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.1118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-voice-id@3.1118.0/index.min.mjs": "sha384-bpoz5rtI7qI1qfZHz7++BAELPvI/mqLP19jRWujoVzUc4vUBUt6L6QOql6ZBc+SC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-voice-id/blob/refs/tags/3.1118.0/LICENSE
```
